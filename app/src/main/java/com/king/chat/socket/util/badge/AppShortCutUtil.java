...
public class AppShortCutUtil {
    ...
    public static void installRawShortCut(Context context, Class<?> clazz, int iconResId,
                                          int appNameResId,boolean isShowNum, String num, boolean isStroke) {
        ...
        if (isStroke) {
            shortcutIntent.putExtra(Intent.EXTRA_SHORTCUT_ICON,
                    generatorNumIcon4(
                            context,
                            ((BitmapDrawable) context.getResources().getDrawable(iconResId)).getBitmap(),
                            isShowNum,
                            num));
        } else {
            shortcutIntent.putExtra(Intent.EXTRA_SHORTCUT_ICON,
     ...
     * @return
     */
    private static boolean isAddShortCut(Context context,int appNameResId) {
        ...
        Cursor c = cr.query(CONTENT_URI,
                ...
                new String[]{context.getString(appNameResId)}, null);
     ...
     * @param clazz   启动的activity
     */
    public static void deleteRawShortCut(Context context, Class<?> clazz,int appNameResId) {
        Intent intent = new Intent("com.android.launcher.action.UNINSTALL_SHORTCUT");
        //快捷方式的名称
        intent.putExtra(Intent.EXTRA_SHORTCUT_NAME, context.getString(appNameResId));
     ...
     * @param isStroke  是否加上边框
     */
    public static void addNumShortCut(Context context, Class<?> clazz, int iconResId,
                                      int appNameResId, boolean isShowNum, String num, boolean isStroke) {
        Log.e(TAG, "manufacturer=" + Build.MANUFACTURER);
        if(isAddShortCut(context,appNameResId)){
            Log.e(TAG, "快捷方式存在");
            return;
        }
        installRawShortCut(context, clazz, iconResId,appNameResId,isShowNum, num, isStroke);
    }
