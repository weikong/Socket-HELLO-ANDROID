...
public class OkHttpClientManager {
    ...
    private OkHttpClientManager() {
        ...
        mOkHttpClient.setReadTimeout(HttpTaskUtil.READ_TIMEOUT, TimeUnit.SECONDS);
        mOkHttpClient.setWriteTimeout(HttpTaskUtil.WRITE_TIMEOUT, TimeUnit.SECONDS);//设置写的超时时间
        mOkHttpClient.setConnectTimeout(HttpTaskUtil.CONNECT_TIMEOUT, TimeUnit.SECONDS);
     ...
     * @throws IOException
     */
    private void _displayImage(final ImageView view, final String url, final int errorResId, final StringCallback callback) {
        final Request request = new Request.Builder()
                .url(url)
                .build();
        Call call = mOkHttpClient.newCall(request);
...
//                    }
    ...
    public static void displayImage(final ImageView view, String url, int errorResId, StringCallback callback) throws IOException {
        getInstance()._displayImage(view, url, errorResId,callback);
    }
