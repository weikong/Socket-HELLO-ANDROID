...
//    private static final String TAG = "JCameraView";
    ...
    public JCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        iconSrc = a.getResourceId(R.styleable.JCameraView_iconSrc, R.drawable.btn_video_flip_camera);
...
//        });
    ...
    public void onResume() {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                setFocusViewWidthAnimation(ScreenUtils.getScreenWidth(getContext()) / 2, ScreenUtils.getScreenHeight(getContext()) / 2);
            }
        },300);
    }
